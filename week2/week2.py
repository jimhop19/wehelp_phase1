...
# bonus = salary *s *p 
# s depends on salary range (salary higher than 40000, s=0.1 ; salary lower than 40000, s = 0.2)
# p depends on performance (above average, p=0.8 ; averge, p=0.5 ; below average, p=0.2)
# r depends on role (CEO, r = 1.1 ; other job titles, r=1)
...
# your code here, based on your own rules
    ...
    for x in workers:
        ...
        if x["role"] == "CEO":
            ...
            r=1
        sum_of_bonus += int(x["salary"]*s*p*r)
    print(sum_of_bonus)
